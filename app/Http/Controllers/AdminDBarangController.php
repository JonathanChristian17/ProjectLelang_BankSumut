<?php namespace App\Http\Controllers;
	...
	class AdminDBarangController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Nilai Limit","name"=>"harga","callback_php"=>'"Rp. ".number_format([harga])'];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'textarea','validation'=>'required|string|min:5|max:1000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nilai Limit','name'=>'harga','type'=>'money','validation'=>'required|min:0|integer','width'=>'col-sm-10','dec_point'=>'.'];
			$this->form[] = ['label'=>'Jaminan Penawaran','name'=>'jam_pena','type'=>'money','validation'=>'required|min:0|integer','width'=>'col-sm-10','dec_point'=>'.'];
			...
			$this->form[] = ['label'=>'Tanggal Pengumuman I','name'=>'tgl_mulai','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tanggal Pengumuman II','name'=>'tgl_mulai2','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tanggal Lelang','name'=>'masa_lelang','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'PIC 1','name'=>'pic1','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'No. HP PIC 1','name'=>'no_pic1','type'=>'text','validation'=>'required|min:1|max:12','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'PIC 2','name'=>'pic2','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'No. HP PIC 2','name'=>'no_pic2','type'=>'text','validation'=>'required|min:1|max:12','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Bukti Kepemilikan','name'=>'bukti','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'SHM;SHGB;BPKB'];
			$this->form[] = ['label'=>'No. Bukti Kepemilikan','name'=>'ket_bukti','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nama Pemilik','name'=>'pemilik','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tanggal Agunan','name'=>'tgl_agunan','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Kelurahan/Desa','name'=>'d_kel_desa_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'d_kel_desa,kel_desa','parent_select'=>'d_kecamatan_id'];
			$this->form[] = ['label'=>'Penyelenggara','name'=>'d_penyelenggara_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'d_penyelenggara,kpk'];
			...
			//$this->form[] = ['label'=>'Jaminan Penawaran','name'=>'jam_pena','type'=>'money','validation'=>'required|min:0|integer','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Bukti Kepemilikan','name'=>'bukti','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'d_provinsi,provinsi'];
			//$this->form[] = ['label'=>'Keterangan Bukti','name'=>'ket_bukti','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Nama Pemilik','name'=>'pemilik','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Tanggal Agunan','name'=>'tgl_agunan','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Alamat','name'=>'alamat','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Provinsi','name'=>'d_provinsi_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'d_provinsi,provinsi'];
			//$this->form[] = ['label'=>'Kabupaten/Kota','name'=>'d_kab_kota_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'d_kab_kota,kab_kota','parent_select'=>'d_provinsi_id'];
			//$this->form[] = ['label'=>'Kecamatan','name'=>'d_kecamatan_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'d_kecamatan,kecamatan','parent_select'=>'d_kab_kota_id'];
			//$this->form[] = ['label'=>'Kelurahan/Desa','name'=>'d_kel_desa_id','type'=>'select','validation'=>'requiredrequired|integer|min:0','width'=>'col-sm-10','datatable'=>'d_kel_desa,kel_desa','parent_select'=>'d_kecamatan_id'];
			# OLD END FORM
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'Foto Barang','path'=>'d_foto','parent_columns'=>'debitur,keterangan','foreign_key'=>'d_barang_id','button_color'=>'success','button_icon'=>'fa fa-bars'];
		...
		public function getDetail($id) {
			...
			$de = $data['row']->d_kel_desa_id;
			$pe = $data['row']->d_penyelenggara_id;
			...
			$data['des'] = DB::table('d_kel_desa')->select('kel_desa')->where('id',$de)->first();
			$data['pen'] = DB::table('d_penyelenggara')->where('id',$pe)->first();
