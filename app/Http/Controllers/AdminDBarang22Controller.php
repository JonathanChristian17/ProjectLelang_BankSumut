<?php namespace App\Http\Controllers;
	...
	class AdminDBarang22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Keterangan Bulanan","name"=>"ket_bulanan"];
			$this->col[] = ["label"=>"Gambar","name"=>"(select d_foto.foto from d_foto where d_foto.d_barang_id = d_barang.id limit 1) as gambar","image"=>true];
			...
			$this->form[] = ['label'=>'Harga Limit','name'=>'harga','type'=>'money','validation'=>'required|min:0|integer','width'=>'col-sm-10','decimals'=>'0','dec_point'=>','];
